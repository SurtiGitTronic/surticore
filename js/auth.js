...
const AuthManager = {
  ...
  async login(username, password) {
    ...
    const session = { userId: user.id, username: user.username, nombre: user.nombre, rol: user.rol, empresaId: user.empresaId, permisos: user.permisos, cargo: user.permisos ? user.permisos.cargo : null };
